source("Paper3_methods_withF.R")
source("Paper3_simulation_withF.R")
source("Paper3_scenarios_withF.R")
...
tmp$method_version <- "withF_newStrength_30IV_indBernoulli"

out_file <- sprintf(
  "results_withF_newStrength_scenario_%s_n%s_cell%02d.rds",
  scen,
  n_i,
  cell_id
)
