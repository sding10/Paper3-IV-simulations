...
write_csv(
  ivnum_F_summary,
  "tables/Paper3_NumIV_2SPS_firststage_F_summary_revised.csv"
)

saveRDS(
  ivnum_F_summary,
  "results_ivnum_combined/Paper3_NumIV_2SPS_firststage_F_summary_revised.rds"
)
